...
[Add](../index.md#add-a-template), [update](../index.md#update-a-template), and [remove](../index.md#remove-a-template) templates from Template Registry through its Github repository, which can be found here: [https://github.com/adobe/aio-template-submission](https://github.com/adobe/aio-template-submission).
...
9. If template fails the verification process (outlined [here](../index.md)), a comment detailing the failed checks will appear.
